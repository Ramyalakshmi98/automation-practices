...
public class Runner_Adactin5 extends Base_Class {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		String username=readdata("C:\\Users\\Galaxy\\eclipse-workspace\\mavenproject\\Adactin.xlsx",1 ,5);
		sendkey(pom.getlogin().getUsername(),username );
		String password=readdata("C:\\Users\\Galaxy\\eclipse-workspace\\mavenproject\\Adactin.xlsx",2 ,5);
